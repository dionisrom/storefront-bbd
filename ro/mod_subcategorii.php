            ...
            <table cellpadding="2" cellspacing="0" border="0" style="white-space:nowrap;">
                ...
                <tr class="<?=$class?>" >
                    ...
                    <td align="center" style="border-bottom:1px solid #000;">
                        ...
                        <img onmouseover="this.style.cursor='pointer';" title="Stergere" src="../ico/delete.png" border=0 onclick="if ( confirm('Esti sigur ca doresti stergerea acestei subcategorii?') ) {document.getElementById('frm').src='sterg.php?db=af&id=<?=$rs[0]?>'}">
                        <img id='save_<?=$rs[0]?>' name="save_<?=$rs[0]?>" style="visibility:hidden;" onmouseover="this.style.cursor='pointer';" title="Salvare modificari" src="../ico/save.png" border="0" onclick="this.style.visibility='hidden';document.getElementById('denumire_<?=$rs[0]?>').className='edit';document.getElementById('denumire_<?=$rs[0]?>').setAttribute('readonly','readonly');document.getElementById('id_cat_<?=$rs[0]?>').setAttribute('disabled','disabled');document.getElementById('id_cat_<?=$rs[0]?>').className='edit';document.getElementById('frm').src='edit.php?db=af&id=<?=$rs[0]?>&val='+document.getElementById('denumire_<?=$rs[0]?>').value+'&id_cat='+document.getElementById('id_cat_<?=$rs[0]?>').value;">
                    </td>
